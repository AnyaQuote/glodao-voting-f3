...
// 			acc: this.acc
// 		});
// 		this.params.erc20TokenContract = contract
// 		await contract.init()
// 		this.decimals = contract.getDecimals();
// 	}
...
// 	getRedeemedAmount = async (address) => {
// 		let res = await this.params.contract
// 			.getContract()
// 			.methods.getRedeemedAmount(address)
// 			.call();
// 		return FixedNumber.from(Numbers.fromDecimals(`${res}`, this.getDecimals()))
// 	}
...
// 		console.log(tokenAmount, amountWithDecimals)
// 		return await this.__sendTx(
...
// 	 * @param {Integer} tokenAmount
// 	 */
// 	fund = async ({ tokenAddress, amount }) => {
// 		let amountWithDecimals = Numbers.toSmartContractDecimals(
// 			amount,
// 			this.getDecimals()
// 		);
...
// 		return await this.__sendTx(
// 			this.params.contract.getContract().methods.fund(tokenAddress, amountWithDecimals),
// 		);
// 	};
...
// 	__assert () {
// 		this.params.contract.use(fixedswapv4, this.getAddress());
// 	}
...
// 	getTokenVestingSchedule = async () =>{
// 		const vestingScheduleLength = await this.params.contract.getContract().methods.getRedeemConfigLength().call();
// 		let promises = []
...
// 		const res = await this.params.contract.getContract().methods.getRedeemConfigAt(index).call()
// 		return {id: Number.parseInt(index) || 0, date: Number.parseInt(res[0]) || 0, percentage: this.web3.utils.fromWei(res[1], 'ether') }
// 	}

// 	/**
//      * @function tokensFund
//      * @description Get amount of token sent to contract
//      * @returns {Integer} token amount
//      */
// 	async tokensFund() {
// 		return  Numbers.fromDecimals (await this.params.contract.getContract()
// 		.methods.tokensFund()
// 		.call(), this.getDecimals())
// 	}
// 	async fundWithdrawed() {
// 		return this.params.contract.getContract().methods.fundWithdrawed().call()
// 	}
// 	async unsoldTokensReedemed() {
// 		return this.params.contract.getContract().methods.unsoldTokensReedemed().call()
// 	}
// }
