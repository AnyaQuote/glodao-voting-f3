...
declare class FixedSwapContract {
    ...
    // getBoughtAmount: (address: string) => Promise<FixedNumber>;
    // getRedeemedAmount: (address: string) => Promise<FixedNumber>;
    // /**
    ...
    //  */
    // fund: ({ tokenAddress, amount }: any) => Promise<any>;
    // /**
    ...
    // getTokenVestingSchedule:() => Promise<TokenVestingSchedule>;
    // getRedeemConfigAt:({index}: any) => Promise<any>;
