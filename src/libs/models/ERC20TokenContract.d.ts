...
declare class ERC20TokenContract {
  constructor({ decimals, contractAddress, web3, acc }: { decimals: any; contractAddress: any; web3: any; acc: any })
  acc: any
  params: {
    web3: any
    contractAddress: any
  ...
  __metamaskCall: ({ f, acc, value, callback }: { f: any; acc: any; value: any; callback?: () => void }) => Promise<any>
  __sendTx: (f: any, call: boolean, value: any, callback?: () => void) => Promise<any>
  __assert(): void
  init(): Promise<any>
  getContract(): any
  getAddress(): any
  setNewOwner: ({ address }: { address: any }) => Promise<any>
  transferTokenAmount({ toAddress, tokenAmount }: { toAddress: any; tokenAmount: any }): Promise<any>
