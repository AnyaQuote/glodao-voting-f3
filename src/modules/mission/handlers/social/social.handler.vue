...
@Component({
  components: {
    [SocialTaskComponent.JOIN_TELEGRAM]: () =>
      import('@/modules/mission/components/social/telegram/telegram-join-task.vue'),
    [SocialTaskComponent.CHAT_TELEGRAM]: () =>
      import('@/modules/mission/components/social/telegram/telegram-chat-task.vue'),
    [SocialTaskComponent.FOLLOW_TWITTER]: () =>
      import('@/modules/mission/components/social/twitter/twitter-follow-task.vue'),
    [SocialTaskComponent.QUOTE_TWITTER]: () =>
      import('@/modules/mission/components/social/twitter/twitter-quote-task.vue'),
    [SocialTaskComponent.COMMENT_TWITTER]: () =>
      import('@/modules/mission/components/social/twitter/twitter-comment-task.vue'),
    [SocialTaskComponent.LIKE_TWITTER]: () =>
      import('@/modules/mission/components/social/twitter/twitter-like-task.vue'),
    [SocialTaskComponent.RETWEET_TWITTER]: () =>
      import('@/modules/mission/components/social/twitter/twitter-retweet-task.vue'),
    [SocialTaskComponent.JOIN_DISCORD]: () =>
      import('@/modules/mission/components/social/discord/discord-join-task.vue'),
    [SocialTaskComponent.FOLLOW_FACEBOOK]: () =>
      import('@/modules/mission/components/social/facebook/follow-facebook-task.vue'),
    [SocialTaskComponent.CUSTOM_TASK]: () => import('@/modules/mission/components/social/custom/custom-task.vue'),
