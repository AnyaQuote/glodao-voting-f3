      ...
      <div class="row mt-100">
        <div class="col-12 col-md-7">
          ...
          <div class="neutral10--text text-h6 mb-9">
            ...
            GloDAO investors will review and vote for your project on Voting. If your project has enough votes, it will
            be launched on Bounty Huter or Launchpad.
          </div>
          <v-btn class="linear-blue--bg white--text text-none" height="fit-content" depressed @click="goToNewProject">
