    ...
    <div class="pa-6">
      ...
      <div class="d-flex flex-column flex-sm-row">
        <div class="mt-6" width="100%">
          ...
          <app-text-field placeholder="Enter amount"></app-text-field>
        </div>
        <div class="pl-0 pl-sm-6 mt-6" width="100%">
      ...
      <div class="d-flex flex-column flex-sm-row">
        <app-text-field flat solo hide-details placeholder="DD/MM/YYYY"></app-text-field>
        <app-text-field class="pl-0 pl-sm-6 mt-6 mt-sm-0" placeholder="00:00"></app-text-field>
      </div>
