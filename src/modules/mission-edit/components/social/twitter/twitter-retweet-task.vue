<template>
  <expand-container class="mt-4" type="twitter" title="Twitter task" subtitle="Retweet a post" @remove="removeSetting">
...
export default class TwitterRetweetTask extends Vue {
